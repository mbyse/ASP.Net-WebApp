    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="page-header">
                ...
                <p class ="lead alert-danger"><asp:Label ID="validationLabel" runat="server" Text="" Visible="false"></asp:Label></p>
            </div>
        ...
        <div class="radio"><label> <asp:RadioButton ID="cashRadioButton" runat="server" GroupName="PaymentGroup" Selected="true"/> Cash</label></div>
